function New-ComplexSubRoutineCall (){
    ...
    New-ComplexSubRoutineCall2 -maxDepth ($maxDepth - 1) -AppInsParentActivity $AppInsRequestActivity
    New-ComplexSubRoutineCall3 -maxDepth ($maxDepth - 1) -AppInsParentActivity $AppInsRequestActivity
