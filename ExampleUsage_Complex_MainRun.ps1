...
Invoke-EERestMethod -Uri $Uri -Method $Method -Body $Body -Headers $Headers -AppInsParentActivity $AppInsRootRequestActivity
...
New-ComplexSubRoutineCall -maxDepth 2 `
